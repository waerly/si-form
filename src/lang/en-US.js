export default {
  ...
  designer: {
    ...
    setting: {
      ...
      paddingLeft: 'paddingLeft Of Row(px)',
      paddingRight: 'paddingRight Of Row(px)',
      paddingTop: 'paddingTop Of Row(px)',
      paddingBottom: 'paddingBottom Of Row(px)',
      gutter: 'Gutter(px)',
