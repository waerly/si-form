...
const COMMON_PROPERTIES = {
  ...
  'sciMinHeight'      :            'sciMinHeight-editor',
  'type'              :            'type-editor',
  ...
  'selectShowValue'   :            'selectShowValue-editor',
  'selectProfile'     :            'selectProfile-editor',
  'suggestGe'         :            'suggestGe-editor',

  'rfSubFun'          :            'rfSubFun-editor',
  'rfName'            :            'rfName-editor',
  'rfCustomFunCode'   :            'rfCustomFunCode-editor',
  'rfShowRow'         :            'rfShowRow-editor',
  'rfCustomCol'       :            'rfCustomCol-editor',
  'rfShowCol'         :            'rfShowCol-editor',
  'rfCriteria'        :            'rfCriteria-editor',
  'rfHeight'          :            'rfHeight-editor',
  'rfOverflowX'       :            'rfOverflowX-editor',
  'rfOverflowY'       :            'rfOverflowY-editor',
  'rfCssStyle'        :            'rfCssStyle-editor',
  ...
  'paddingLeft'        :            'paddingLeft-editor',
  'paddingRight'       :            'paddingRight-editor',
  'paddingTop'         :            'paddingTop-editor',
  'paddingBottom'      :            'paddingBottom-editor',
